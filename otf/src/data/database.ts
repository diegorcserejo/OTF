...
const oneAndMembers: Member[] = [
  { name: 'Biel', role: 'Main Vocal, Lead Rapper, Sub Dancer', birthday: '27 de Março de 2002', height: '178 cm', nationality: 'Brazilian/Thai', image: '/Biel.jpeg', stats: { Vocal: 96, Dance: 68, Rap: 82, Visual: 84 } },
  { name: 'Cauy', role: 'Main Vocal, Sub Rapper, Sub Dancer', birthday: '17 de Março de 2003', height: '173 cm', nationality: 'Japanese', image: '/Cauy.jpeg', stats: { Vocal: 99, Dance: 65, Rap: 55, Visual: 85 } },
  { name: 'Guhan', role: 'Sub Vocal, Visual, Sub Rapper', birthday: '20 de Setembro de 2001', height: '175 cm', nationality: 'Brazilian/Taiwanese', image: '/Guhan.jpeg', stats: { Vocal: 68, Dance: 70, Rap: 62, Visual: 94 } },
  { name: 'Iggy', role: 'Leader, Main Rapper, Vocalista, Sub Dancer', birthday: '29 de Março de 2003', height: '182 cm', nationality: 'Korean/Brazilian', image: '/Iggy.jpeg', stats: { Vocal: 78, Dance: 65, Rap: 97, Visual: 88 } },
  { name: 'Leb', role: 'Main Dancer, Visual, Vocalista, Sub Rapper', birthday: '05 de Junho de 2004', height: '192 cm', nationality: 'Brazilian', image: '/Leb.jpeg', stats: { Vocal: 75, Dance: 98, Rap: 60, Visual: 95 } },
  { name: 'Luna', role: 'Lead Vocal, Lead Rapper, Lead Dancer', birthday: '16 de Maio de 2003', height: '172 cm', nationality: 'Brazilian', image: '/Luna.jpeg', stats: { Vocal: 88, Dance: 88, Rap: 85, Visual: 80 } },
  { name: 'Lune', role: 'Face, Center, Visual, Lead Dancer, Sub Vocal, Maknae', birthday: '29 de Novembro de 2004', height: '175 cm', nationality: 'Brazilian/Arab', image: '/Lune.jpeg', stats: { Vocal: 70, Dance: 89, Rap: 40, Visual: 97 } }
];
...
const prettysinExMembers: Member[] = [
  { name: 'Lari', role: 'Lead Vocal, Visual, Sub Rapper, Main Dancer', birthday: '22 de Abril', height: '170 cm', nationality: 'Brazilian', image: '/Lari.jpeg', stats: { Vocal: 82, Dance: 92, Rap: 68, Visual: 90 } },
  ...
  { name: 'Carlos', role: 'Sub Vocal, Main Rapper, Sub Dancer', birthday: '12 de Setembro', height: '180 cm', nationality: 'Brazilian', image: '/Carlos.jpeg', stats: { Vocal: 66, Dance: 74, Rap: 92, Visual: 76 } }
];
